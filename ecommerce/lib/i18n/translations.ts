export const translations = {
  en: {
    ...
    "admin.contactTitle": "Contact Information",
    "admin.contactSubtitle": "Manage your store's contact information.",
    "admin.contactInfoSection": "Contact Information",
    "admin.contactEmail": "Public Contact Email",
    "admin.contactEmailHelper": "This email will be shown to customers in notifications.",
    "admin.contactPhone": "Phone / WhatsApp",
    "admin.contactAddress": "Physical Address",
    "admin.saveChanges": "Save Changes",
    "admin.saving": "Saving...",
    "admin.infoUpdated": "Information updated successfully",
    "admin.errorSaving": "Error saving information",
    "admin.noBrandingYet": "You haven't configured your brand information yet. Complete the form to get started.",
  ...
  es: {
    ...
    "admin.contactTitle": "Información de Contacto",
    "admin.contactSubtitle": "Administra la información de contacto de tu tienda.",
    "admin.contactInfoSection": "Información de Contacto",
    "admin.contactEmail": "Email de Contacto Público",
    "admin.contactEmailHelper": "Este email se mostrará a los clientes en las notificaciones.",
    "admin.contactPhone": "Teléfono / WhatsApp",
    "admin.contactAddress": "Dirección Física",
    "admin.saveChanges": "Guardar Cambios",
    "admin.saving": "Guardando...",
    "admin.infoUpdated": "Información actualizada correctamente",
    "admin.errorSaving": "Error al guardar la información",
    "admin.noBrandingYet": "Aún no has configurado la información de tu marca. Completa el formulario para empezar.",
